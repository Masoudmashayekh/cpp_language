...
void loop(void)
 ...
 ////////////////////////////////////////////////////////////  Panel voltage  //////////////////////////////////////////////////////////////////////////////  
  ...
  //Serial.print("Voltage(P): ");
  Serial.print(Vin1);
  //Serial.print(" V");
  Serial.print(" , ");
  ///////////////////////////////////////////////////////////////// Current sensor of Dc load //////////////////////////////////////////////////////////////////////////////
 unsigned int dx=0;
 float dAcsValue=0.0,dSamples=0.0,dAvgAcs=0.0,dAcsValueF=0.0;

  for (int dx = 0; dx < 150; dx++){ //Get 150 samples
  dAcsValue = analogRead(A6);     //Read current sensor values   
  dSamples = dSamples + dAcsValue;  //Add samples together
  delay (3); // let ADC settle before next sample 3ms
 } 
  dAvgAcs=dSamples/150.0;//Taking Average of Samples
 ...
 //you must change the offset according to the input voltage)
 //0.100v(100mV) is rise in output voltage when 1A current flows at input
  dAcsValueF = ((2.5 - (dAvgAcs * (5.0 / 1024.0)) )/0.100) + 0.35;


  //Serial.print("Current(DC): ");
  Serial.print(dAcsValueF);
  //Serial.print(" A");
  Serial.print(" , ");
